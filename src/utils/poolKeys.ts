...
import { AccountInfo, PublicKey, Keypair } from '@solana/web3.js';
...
export async function derivePoolKeys(marketId: PublicKey, keypair: Keypair) {
  ...
  const ownerBaseAta = await getOwnerAta(baseMint, keypair.publicKey);
  ...
  const ownerQuoteAta = await getOwnerAta(quoteMint, keypair.publicKey);
  ...
  const poolKeys = {
    ...
    id: PublicKey.findProgramAddressSync(
      [RayLiqPoolv4.pubKey.toBuffer(), marketId.toBuffer(), Buffer.from('amm_associated_seed', 'utf-8')],
      RayLiqPoolv4.pubKey
    )[0],
    baseVault: PublicKey.findProgramAddressSync(
      [RayLiqPoolv4.pubKey.toBuffer(), marketId.toBuffer(), Buffer.from('coin_vault_associated_seed', 'utf-8')],
      RayLiqPoolv4.pubKey
    )[0],
    coinVault: PublicKey.findProgramAddressSync(
      [RayLiqPoolv4.pubKey.toBuffer(), marketId.toBuffer(), Buffer.from('pc_vault_associated_seed', 'utf-8')],
      RayLiqPoolv4.pubKey
    )[0],
    lpMint: PublicKey.findProgramAddressSync(
      [RayLiqPoolv4.pubKey.toBuffer(), marketId.toBuffer(), Buffer.from('lp_mint_associated_seed', 'utf-8')],
      RayLiqPoolv4.pubKey
    )[0],
    lpVault: PublicKey.findProgramAddressSync(
      [RayLiqPoolv4.pubKey.toBuffer(), marketId.toBuffer(), Buffer.from('temp_lp_token_associated_seed', 'utf-8')],
      RayLiqPoolv4.pubKey
    )[0],
    targetOrders: PublicKey.findProgramAddressSync(
      [RayLiqPoolv4.pubKey.toBuffer(), marketId.toBuffer(), Buffer.from('target_associated_seed', 'utf-8')],
      RayLiqPoolv4.pubKey
    )[0],
    withdrawQueue: PublicKey.findProgramAddressSync(
      [RayLiqPoolv4.pubKey.toBuffer(), marketId.toBuffer(), Buffer.from('withdraw_associated_seed', 'utf-8')],
      RayLiqPoolv4.pubKey
    )[0],
    openOrders: PublicKey.findProgramAddressSync(
      [RayLiqPoolv4.pubKey.toBuffer(), marketId.toBuffer(), Buffer.from('open_order_associated_seed', 'utf-8')],
      RayLiqPoolv4.pubKey
    )[0],
